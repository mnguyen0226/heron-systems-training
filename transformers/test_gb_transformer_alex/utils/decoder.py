...
from utils.encoder import LNorm, Attn
...
class GatedDecoderLayer(nn.Module):
    def __init__(self, hid_dim, n_heads, pf_dim, dropout, device):
        ...
        self.self_attention = Attn(hid_dim, n_heads, dropout, device)
        ...
        self.encoder_attention = Attn(hid_dim, n_heads, dropout, device)
        ...
        self.positionwise_feedforward = Projection(hid_dim, pf_dim, dropout)
