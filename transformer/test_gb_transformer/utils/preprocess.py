...
def tokenize_de(text):
    ...
    """
    return [tok.text for tok in spacy_de.tokenizer(text)] # this is just parsing, not vectorized yet
...
def tokenize_en(text):
    ...
    text:
        input text sentence(s)
    """
    return [tok.text for tok in spacy_en.tokenizer(text)] # this is just parsing, not vectorized yet 
